...
global.owner = process.env.OWNER_NUMBER || "2348083504565";
...
module.exports = {
  ...
  author: process.env.PACK_AUTHER || "Danzycool",
  packname: process.env.PACK_NAME || "Danzycool",
  botname: process.env.BOT_NAME || "Danzycool",
  ownername: process.env.OWNER_NAME || "Danzycool",
